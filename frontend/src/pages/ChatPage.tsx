...
export function ChatPage() {
  ...
  // 🆕 26/07 18:19 — Listener: ProfileEditModal dispara evento pra navegar p/ Planos
  useEffect(() => {
    const handler = () => navigate('/planos')
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <header className="glass px-3 sm:px-6 py-3 sm:py-4 flex items-center gap-2 sm:gap-3 flex-shrink-0">
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            {/* 🆕 26/07 18:19 — Botão Planos REMOVIDO daqui, movido pra DENTRO do ProfileEditModal (Rafael pediu) */}
