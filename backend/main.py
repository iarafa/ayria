...
from routers import admin_alma, admin_analysis, admin_backfill, coupons, stripe_billing, partner_auth
...
app.include_router(partner_auth.router)   # 🆕 26/07 22:43 — login do parceiro (JWT próprio)
