...
# === PALAVRAS SOLTAS & VARIAÇÕES VERBAIS (N1) ===
# Cobertura por forma conjugada — vai pegar "vou morrer", "morrendo", "matou" etc.
# O "\b" é adicionado pelo parser; aqui deixamos a forma base.
- morrer
...
## SLIGHT — VERBOS SOLTOS (risco depende de contexto)

# Estas dependem de CONTEXTO. Sem contexto (sozinhas) podem ser irônicas
# ("morreu de rir", "matou a fome"). Com contexto de risco, viram N1 via IA batch.
# Aqui são detectadas como ATENCAO (risco moderado) e confirmadas via IA batch.
- "morrer"
- "morrendo"
- "morreu"
- "morto"
...
## NEGATIVE — FALSOS POSITIVOS CONHECIDOS
# Anulam match de ATENCAO (sinais moderados) quando em contexto não-violento.
# Casos clássicos: "morreu de rir", "matou a fome", etc.
# Não anulam N1/N2/N3 explícitos ("quero morrer" na msg = risco real sempre).
- "de rir"
- "de rir"
- "de rir!"
- "de rir kkk"
...
- "matei o bicho"
- "matar o bicho"
- "morreu de fome"      # NÃO anula N1 — só ATENCAO (sem contexto)
- "morto de cansado"
- "morta de cansada"
- "morto de fome"
- "morreu de medo"
- "tô morta"
- "to morta"
- "tô morto"            # cansancio/exaustao, nao violencia
- "to morto"             # exaustao
- "mortos de cansaço"
- "socorro morri de"
- "mata leão"           # jogo
